...
<div id="mainfeed">
	...
	?>
	<div class = "circle">
		 <a href="viewsav.php" id="sss"> <img src="Background/saved.jpeg" class = "back" /> 
	...
	<?php
		mysqli_select_db($connect,"justfeed");
		$q = mysqli_query($connect,"select * from article where userid='$data[7]' order by uploadtime desc ");
